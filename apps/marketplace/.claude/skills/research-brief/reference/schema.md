...
4. `## How This Connects` — a ` ```mermaid ` flowchart of the physical/capital layers (this is the render of `graphLayers`, done as an actual diagram instead of four text blocks)
